...
member_1 = Member("Charlie Chabby", 32, "charlie@mail.com", False, True)
member_repository.save(member_1)

member_2 = Member("Sushi Chonky", 23, "sushi@mail.com", True, True)
member_repository.save(member_2)

member_3 = Member("Olive Oil", 34, "olive@mail.com", False, False)
